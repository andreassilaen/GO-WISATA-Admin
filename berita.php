...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        if(($ekstensifile == "jpg") or ($ekstensi == "JPG"))
        {
            ...
            mysqli_query($connection, "insert into berita value 
            ('$kodefoto', '$namafoto', '$isiberita','$kodedestinasi', '$nama')");
        }
    }
        ...
        <form method="POST">
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        value="<?php if(isset($_POST['search'])) {echo $_POST['search'];}?>" placeholder="Cari Judul">
                    </div>
