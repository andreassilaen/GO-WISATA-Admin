...
<?php 
    ...
    if(isset($_POST['Ubah']))
    {
        ...
        if(empty($nama))
        {
            mysqli_query($connection, "UPDATE fotodestinasi 
            SET fotonama = '$namafoto', destinasiID = '$kodedestinasi'
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            destinasiID = '$kodedestinasi', fotoFile = '$nama'
            WHERE fotoID = '$kodefoto'");
            header("loaction:photoDestinasi.php");
        }
    }
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <select class="form-control" id="namadestinasi" name="kodedestinasi">
                    <option value="<?php echo $rowedit["destinasiID"]?>"><?php 
                     echo $rowedit['destinasiID']?> <?php echo $rowedit2['destinasiNama']?></option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <img src="images/<?php echo $rowedit['fotoFile']?>" style="width: 200px;
                        height: 100px;">
            ...
            <tbody>
                ...
                {?>
                    <tr>
                        ...
                        <td>
                        <a href="photoDestinasiUbah.php?ubahfoto=<?php echo $row["fotoID"]?>"
                        ...
                        <td>
                        <a href="photoDestinasiHapus.php?hapusfoto=<?php echo $row["fotoID"]?>"
