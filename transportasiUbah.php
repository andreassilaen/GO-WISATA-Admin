...
<?php 
    ...
    if(isset($_POST['Ubah']))
    {
        ...
        if(empty($nama))
        {
            mysqli_query($connection, "UPDATE transportasi
            SET transportasiNama = '$namafoto', areaID = '$kodedestinasi'
            WHERE transportasiID = '$kodefoto'");
            header("location:transportasi.php");
        } 
        else
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "UPDATE transportasi SET transportasiNama = '$namafoto',
            areaID = '$kodedestinasi', transportasiFoto = '$nama'
            WHERE transportasiID = '$kodefoto'");
        }
    }
    ...
    $editfoto = mysqli_query($connection, "SELECT * FROM transportasi
        WHERE transportasiID = '$kodefoto'");
    $rowedit = mysqli_fetch_array($editfoto);

    $editdestinasi = mysqli_query($connection, "SELECT * FROM area, transportasi
        WHERE transportasiID = '$kodefoto' AND area.areaID = transportasi.areaID");
...
<div class="row">
    ...
    <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Edit Transportasi</h1>
            </div>
        </div>

        <form method="POST" enctype="multipart/form-data">
            <div class="form-group row">
                <label for="kodefoto" class="col-sm-3 col-form-label">Kode Transportasi</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="kodefoto" name="inputkode"
                    value="<?php echo $rowedit["transportasiID"]?>">
                </div>
            </div>

            <div class="form-group row">
                <label for="namafoto" class="col-sm-3 col-form-label">Nama transportasi</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="namafoto" name="inputnama"
                    value="<?php echo $rowedit["transportasiNama"]?>">
                </div>
            </div>

            <div class="form-group row">
                <label for="namadestinasi" class="col-sm-3 col-form-label">Area</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="file" class="col-sm-3 col-form-label">Foto transportasi</label>
                <div class="col-sm-9">
                    <input type="file" id="file" name="file">
                    <img src="images/<?php echo $rowedit['transportasiFoto']?>" style="width: 200px;
                        height: 130px;">
...
<div class="row">
    ...
    <div class="col-sm-10"> <!-- ini bener ga pake class=? --->
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Daftar Transportasi</h1>
            </div>             
        </div>                    
        ...
        <table class="table table-hover table-success">
            ...
            <tbody>
                <?php $query = mysqli_query($connection, "SELECT * FROM transportasi");
                $nomor = 1;
                ...
                {?>
                    <tr>
                        ...
                        <td>
                            <?php if(is_file("images/".$row['transportasiFoto']))
                            {?>
                                <img src="images/<?php echo $row['transportasiFoto']?>" width="80">
                            <?php } else
                        ...
                        <td>
                        <a href="transportasiUbah.php?ubahfoto=<?php echo $row["transportasiID"]?>"
                        ...
                        <td>
                        <a href="transportasiHapus.php?hapusfoto=<?php echo $row["transportasiID"]?>"
