...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        if(($ekstensifile == "jpg") or ($ekstensi == "JPG"))
        {
            move_uploaded_file($file_tmp, 'images/'.$nama); // unggah file ke folder iamges
            mysqli_query($connection, "insert into transportasi value 
            ('$kodefoto', '$namafoto', '$kodedestinasi', '$nama')");
        }
    }
...
<div class="row">
    ...
    <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Input Transportasi</h1>
            </div>
        </div>
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    placeholder="Kode Transportasi" maxlength="4">
                </div>
            </div>
    ...
    <div class="col-sm-10"> <!-- ini bener ga pake class=? --->
        ...
        <form method="POST">
                <div class="form-group row mb-2">
                    <label for="search" class="col-sm-3">Nama Tranportasi</label>
                    <div class="col-sm-6">
                        <input type="text" name="search" class="form-control" id="search"
                        value="<?php if(isset($_POST['search'])) {echo $_POST['search'];}?>" placeholder="Cari Nama Transportasi">
                    </div>
            ...
            <tbody>
                ...
                {?>
                    <tr>
                        ...
                        <td>
                        <a href="trasnportasihapus.php?hapusfoto=<?php echo $row["transportasiID"]?>"
