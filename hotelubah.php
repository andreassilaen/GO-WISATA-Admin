...
<?php 
    ...
    if(isset($_POST['Ubah']))
    {
        ...
        if(empty($nama))
        {
            ...
            SET hotelNama = '$namafoto', areaID = '$kodedestinasi'
            WHERE hotelID = '$kodefoto'");
            header("location:hotel.php");
        } 
        else
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "UPDATE hotel SET hotelNama = '$namafoto',
            areaID = '$kodedestinasi', hotelFoto= '$nama'
            WHERE hotelID = '$kodefoto'");
            header("loaction:hotel.php");
        }
    }
    ...
    $editfoto = mysqli_query($connection, "SELECT * FROM hotel
        WHERE hotelID = '$kodefoto'");
    $rowedit = mysqli_fetch_array($editfoto);

    $editdestinasi = mysqli_query($connection, "SELECT * FROM area,hotel
        WHERE hotelID = '$kodefoto' AND area.areaID = hotel.areaID");
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <img src="images/<?php echo $rowedit['hotelFoto']?>" style="width: 200px;
                        height: 130px;">
            ...
            <tbody>
                ...
                {?>
                    <tr>
                        ...
                        <td>
                        <a href="hotelubah.php?ubahfoto=<?php echo $row["hotelID"]?>"
